  ...
  def main(args: Array[String]): Unit = {
    ...
    listConf.forEach(map => {
      ...
      if (list.size() > 1) {
        ...
        val s: String = HttpUtils.doFilePost("http://47.119.177.201:8992/open/dict-create", map, "jHamPtd3SQ7dKeMSl4pR6ep5ypt0yDzqD4dsttDXOemfP6lmLk53qjwAV71gVDXn", fileName)
