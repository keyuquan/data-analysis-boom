  ...
  def main(args: Array[String]): Unit = {
    ...
    listConf.forEach(map => {
      ...
      if (list.size() > 1) {
        ...
        map.put("createParam", "{\"mainColumn\":{\"property\":{\"columnName\":\"#vp@planday\",\"tableType\":\"user\",\"timestampJoinFormat\":null}},\"columns\":[{\"property\":{\"columnName\":\"ta_id\",\"columnDesc\":\"巨量计划加日期\",\"selectType\":\"string\"}},\n{\"property\":{\"columnName\":\"activeTime\",\"columnDesc\":\"巨量激活时间\",\"selectType\":\"date\"}},{\"property\":{\"columnName\":\"pkginfo\",\"columnDesc\":\"包名\",\"selectType\":\"string\"}},{\"property\":{\"columnName\":\"plan_id\",\"columnDesc\":\"广告计划ID\",\"selectType\":\"string\"}},{\"property\":{\"columnName\":\"campaign_id\",\"columnDesc\":\"广告组ID\",\"selectType\":\"string\"}},{\"property\":{\"columnName\":\"plancost\",\"columnDesc\":\"消耗金额\",\"selectType\":\"number\"}},{\"property\":{\"columnName\":\"planactive\",\"columnDesc\":\"激活数\",\"selectType\":\"number\"}},{\"property\":{\"columnName\":\"planaction\",\"columnDesc\":\"转化数\",\"selectType\":\"number\"}},{\"property\":{\"columnName\":\"adImpressions\",\"columnDesc\":\"投放位置\",\"selectType\":\"string\"}}]}")
